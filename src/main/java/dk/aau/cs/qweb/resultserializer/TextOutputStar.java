...
public class TextOutputStar extends OutputBase
{
    ...
    public TextOutputStar(Prologue prologue)
    { context = new SerializationContext(prologue) ; }
    
    public TextOutputStar(PrefixMapping pMap)
    { context = new SerializationContext(pMap) ; }

    public TextOutputStar(SerializationContext cxt )
    { context = cxt ; }
    ...
    protected String getVarValueAsString(QuerySolution rBind, String varName) {
        ...
        return FmtUtilsStar.stringForRDFNode(obj, context);
    }
