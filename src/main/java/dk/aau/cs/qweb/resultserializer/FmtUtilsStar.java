...
public class FmtUtilsStar
{
    ...
    public static String stringForLiteral(SimpleLiteralNode literal, SerializationContext context)
    {
        StringBuilder result = new StringBuilder(  );
    ...
    public static void stringForLiteral(StringBuilder result, SimpleLiteralNode literal, SerializationContext context)
    {
...
//        }
    ...
    public static void stringForNode(StringBuilder result, Node n, SerializationContext context)
    {
        ...
        if ( n.isBlank() ) {
            ...
            stringForLiteral(result, (SimpleLiteralNode)n, context) ;
        } else if ( n.isURI() ) {
            String uri = n.getURI() ;
