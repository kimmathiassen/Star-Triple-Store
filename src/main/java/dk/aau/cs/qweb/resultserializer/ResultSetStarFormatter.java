...
//    { out(out, qresults, query.getPrefixMapping()) ; }
    ...
    {
        TextOutputStar tFmt = new TextOutputStar(pmap) ;
    ...
    {
        TextOutputStar tFmt = new TextOutputStar(prologue) ;
        tFmt.format(out, qresults) ;
    }
    ...
    {
        TextOutputStar tFmt = new TextOutputStar((SerializationContext)null) ;
    ...
    public static String asText(ResultSet qresults, Prologue prologue)
    {
        ...
        {
            Log.warn(ResultSetStarFormatter.class, "UnsupportedEncodingException") ;
            return null ;
        }
    }
